...
function ShortBlogCard() {
  return (
    <div className="pl-2 first-letter pr-5 py-2 rounded-lg flex flex-row bg-cardColor items-center justify-center shadow-md hover:shadow-lg transition-shadow duration-300">
      {/* Blog Image Section */}
      <div
