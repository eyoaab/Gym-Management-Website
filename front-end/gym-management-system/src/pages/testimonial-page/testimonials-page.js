    ...
    <div className=" grid grid-cols-1 lg:grid-cols-2 gap-1 px-16 pt-5" >
      <div className="flex flex-col justify-center items-center lg:items-start">
        ...
        <div className="flex items-center justify-start mb-6 relative">
          <IoIosArrowForward color='#DDCA24' size={80} className="relative z-10 cursor-pointer" />
          <IoIosArrowForward color='#FAFAF9' size={80} className="absolute left-6 top-0 z-0 cursor-pointer" />
        </div>
