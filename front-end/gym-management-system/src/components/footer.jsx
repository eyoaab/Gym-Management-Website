...
function Footer() {
  return (
    <div className="flex flex-col items-stretch bg-white px-10">
    <footer className="flex flex-col">
    <div className="py-10 px-6 grid grid-cols-1 md:grid-cols-[2fr,1fr,1fr,1fr] gap-8 items-start">
        {/* First column */}
        <div className="flex flex-col items-start space-y-4 text-left ">
          <div className="flex items-start space-x-3">
            <img src="blackLogo.png " alt="CoreFit Club Logo" className="w-10 h-10" />
            <h1 className="font-saira text-4xl">COREFIT CLUB</h1>
          </div>
          <p className="text-sm text-darkGray w-3/5">
            <span className="font-saira  text-black text-left">Address: </span>
            Addis Abeba, Adsisu Gebeya, Belete Mole 2nd floor
          </p>
          <h1 className="font-saira  text-lg">Social Media Links:</h1>
          <div className="flex space-x-4 text-xl">
            <PiFacebookLogoBold aria-label="Facebook" className="hover:text-blue-600 cursor-pointer" />
            <CiInstagram aria-label="Instagram" className="hover:text-pink-600 cursor-pointer" />
            <FaTelegram aria-label="Telegram" className="hover:text-blue-400 cursor-pointer" />
            <FaYoutube aria-label="YouTube" className="hover:text-red-600 cursor-pointer" />
          </div>
        </div>
        ...
        <div className="text-left">
          ...
          <div className="flex items-center space-x-2 mt-2">
            ...
            <span className="text-sm text-darkGray">+(251)9-123-456-789</span>
          </div>
        </div>
      </div>
    ...
    <div className="py-4 text-center text-sm text-darkGray">
        Copyright &copy; {new Date().getFullYear()} COREFIT CLUB. All Rights Reserved.
      </div>
    </div>
  );
}
